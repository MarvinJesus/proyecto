...
import { ProyectoSharedModule } from 'app/shared';
import { ProyectoCoreModule } from 'app/core';
import { ProyectoAppRoutingModule } from './app-routing.module';
import { ProyectoHomeModule } from './home/home.module';
import { ProyectoAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    ProyectoSharedModule.forRoot(),
    ProyectoCoreModule,
    ProyectoHomeModule,
    ProyectoAccountModule,
